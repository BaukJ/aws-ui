...
```
cd existing_repo
git remote add origin https://gitlab.version1.com/kuba.jasko/aws-ui.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.version1.com/kuba.jasko/aws-ui/-/settings/integrations)
